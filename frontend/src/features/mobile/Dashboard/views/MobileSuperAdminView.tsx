    ...
    <div className="space-y-5" data-superadmin-overview>
      ...
      <section className="rounded-[22px] border border-glass-border bg-card p-4 shadow-sm">
        <div className="flex items-center justify-between gap-3">
          <div><p className="text-[9px] font-black uppercase tracking-[0.16em] text-primary">Approvisionnement global</p><h3 className="mt-1 text-base font-black">Control-plane</h3></div>
