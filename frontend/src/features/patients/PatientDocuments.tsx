                  ...
                  {!isLegacy && (
                    <div className="relative">
                      ...
                      {actionsOpenFor === doc.id && (
                        <div id={`document-actions-${doc.id}`} data-document-action-menu role="menu" className="absolute left-1/2 -translate-x-1/2 top-12 z-50 w-48 rounded-xl border border-slate-200/80 bg-white/95 shadow-xl backdrop-blur-xl p-1.5">
