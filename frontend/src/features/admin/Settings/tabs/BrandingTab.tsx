...
export const BrandingTab: React.FC = () => {
  ...
  return (
    <div className={cn("transition-all duration-500 ease-in-out", showPdfPreview ? "lg:mr-[620px] xl:mr-[640px]" : "mr-0")}>
      ...
      <div className={cn("fixed bottom-8 z-[15000] transition-all duration-500 ease-in-out", showPdfPreview ? "right-[620px] xl:right-[660px]" : "right-8")}>
        <motion.button
