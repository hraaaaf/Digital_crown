...
export function computeStep3Data(lms:Landmark[],age:number|'',_sexe:'M'|'F',mmPerPixel:number|null,etape2:DonneesEtape2|null=null):Partial<DonneesEtape3>{
  ...
  const results:Partial<DonneesEtape3>={age,cvm:'',denture_type:'',dentaire:{surplomb:'',recouvrement:'',impa:'',i_francfort:'',inter_incisif:''},osseuse:{angle_tweed:'',decalage_ab:'',situation_a:'',situation_b:'',profondeur_faciale:'',sna:'',snb:'',anb:''},esthetique:{ligne_e_ls:'',ligne_e_li:'',angle_nasolabial:''}};
