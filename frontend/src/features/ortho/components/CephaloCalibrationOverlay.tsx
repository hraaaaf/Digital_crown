...
export const CephaloCalibrationOverlay = ({
  ...
  const calibrationColor = P.accentWarning;
          ...
          {!activeDragId && magnifier.show && (
            <g opacity="0.6">
              <line
                ...
                stroke={calibrationColor} strokeWidth="0.5" strokeDasharray="2,2"
              />
              <line
                ...
                stroke={calibrationColor} strokeWidth="0.5" strokeDasharray="2,2"
              />
              <circle cx={magnifier.x} cy={magnifier.y} r="15" fill="none" stroke={calibrationColor} strokeWidth="0.5" strokeDasharray="1,2" />
            </g>
          )}
          ...
          {calibrationPoints && calibrationPoints.map((cpt, i) => (
            <g key={`calib-group-${i}`}>
              <path
                ...
                stroke={calibrationColor} strokeWidth="2" vectorEffect="non-scaling-stroke"
              />
              <circle cx={cpt.x} cy={cpt.y} r="4" fill={calibrationColor} />
            </g>
          ))}
          {calibrationPoints && calibrationPoints.length === 2 && (
            <g>
              <line
                ...
                stroke={calibrationColor} strokeWidth="2" strokeDasharray="6,4"
              ...
              <rect
                ...
                width="40" height="20" rx="4" fill={calibrationColor}
              />
              <text
                ...
                fontSize="10" fontWeight="bold" fill={P.text} textAnchor="middle"
              >
                REF
              </text>
            </g>
