...
if (self.pageErrors.length || self.consoleErrors.length) {
  throw new Error(`chromium patient runtime errors: ${JSON.stringify({ pageErrors: self.pageErrors, consoleErrors: self.consoleErrors })}`);
}
