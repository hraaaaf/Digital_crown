...
- [ ] **Vue Agenda Compl�te** : Possibilit� de consulter la totalit� de l'agenda depuis le mobile.
- [ ] **Gestion des RDV** : Ajouter, modifier et supprimer des rendez-vous directement depuis le smartphone en toute s�curit� (ZKA).

---

## ?? 31. Guide de Prescription Odontologique (P�diatrique & Adulte)
**Statut :** � planifier
**Priorit� :** Moyenne

- [ ] **Base de connaissances (Maroc)** : Int�gration des posologies (Antalgiques, Antibiotiques, AINS) sp�cifiques � l'odontologie au Maroc.
- [ ] **Calcul intelligent (Poids/�ge)** : Bouton interactif / Ghost Brain qui sugg�re la posologie exacte en fonction du poids et de l'�ge du patient.

---

## ?? 32. Suivi de Paiement Ortho & �chelonnement
**Statut :** � planifier
**Priorit� :** Moyenne
