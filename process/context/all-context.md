...
- **Database:** PostgreSQL (digitalcrown_db) via SQLAlchemy ORM & Alembic migrations — localhost, user postgres
...
- Mode: merge
- Package manager: npm
-   [ o r t h o - b o t - k n o w l e d g e . m d ] ( . / o r t h o - b o t - k n o w l e d g e . m d )   -   B a s e   d e   c o n n a i s s a n c e s   d � t e r m i n i s t e   p o u r   l e   f u t u r   s y s t � m e   E x p e r t   s a n s   L L M  
 