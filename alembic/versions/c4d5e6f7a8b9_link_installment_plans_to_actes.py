...
Global/legacy installment plans remain valid with acte_id=NULL. Patient-page plans
can now carry an explicit Acte link and be reconciled transactionally.
"""
