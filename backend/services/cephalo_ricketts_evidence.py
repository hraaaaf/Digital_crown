...
R9 certifies Facial Depth only. Facial Axis, Point A Convexity and E-line lip
distances remain explicit blocked contracts until their exact constructions are
source-locked. No norms, diagnosis, growth forecast or treatment logic is
activated here.
"""
...
RICKETTS_BLOCKED_CONTRACTS = {
    "RICKETTS_FACIAL_AXIS_DEG_V1": "BLOCKED_LANDMARK_CONVENTION: Ricketts facial axis uses constructed Gnathion (Gn') while SRPose38 exposes annotated Gn; construction equivalence is not source-certified",
    ...
    "RICKETTS_E_LINE_LS_MM_V1": "BLOCKED_GEOMETRIC_CONVENTION: sources diverge between horizontal lip-to-E-line distance and perpendicular point-to-line distance",
    "RICKETTS_E_LINE_LI_MM_V1": "BLOCKED_GEOMETRIC_CONVENTION: sources diverge between horizontal lip-to-E-line distance and perpendicular point-to-line distance",
}
