...
_PAGE_1 = (
    ...
    InsuranceOverlayPlacement("administrative.beneficiary_birth_date", 0, 790, 296, 7.0, max_chars=10),
    InsuranceOverlayPlacement("administrative.beneficiary_national_id", 0, 800, 317, 8.0, max_chars=16),
