...
def build_cephalo_runtime_evidence_payload(
    *, patient_id: int, image_record_id: str, result: CephaloAnalysisResult,
    ...
    mcnamara_nperp_constructions = materialize_mcnamara_nperp_constructions(
        current_by_id,
        construction_namespace=f"construction:{resolved_case}:r{revision}:mcnamara:nperp",
    )
    ...
    calibration_ref = calibration.evidence_id if calibration else None
    craniom_measurements = adapt_craniom_linear_measurements(
        ...
        constructions=craniom_constructions, calibration_ref=calibration_ref,
    )
    ...
    mcnamara_nperp_measurements = adapt_mcnamara_nperp_measurements(
        measurement_namespace=f"measurement:{resolved_case}:r{revision}:mcnamara:nperp",
