...
def adapt_craniom_linear_measurements(result: CephaloAnalysisResult, *, measurement_namespace: str, constructions: Mapping[str, ConstructionEvidence], calibration_ref: Optional[str]) -> list[MeasurementEvidence]:
    return adapt_craniom_measurements(result, measurement_namespace=measurement_namespace, constructions=constructions, calibration_ref=calibration_ref)
...
CRANIOM_CONSTRUCTION_DEFINITIONS = (*CRANIOM_LINEAR_CONSTRUCTION_DEFINITIONS, *CRANIOM_ANGULAR_CONSTRUCTION_DEFINITIONS)
