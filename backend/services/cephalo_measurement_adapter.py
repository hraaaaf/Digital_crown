...
_CRANIOM_LINEAR_SPECS: Sequence[_MeasurementSpec] = (
    _MeasurementSpec(metric_name="Situation_A", metric_group="skeletal", method_id="CRANIOM_SITUATION_A_MM_V1", construction_definition_id="CRANIOM_A_TO_N_VERTICAL_V1", unit="mm", requires_calibration=True),
    _MeasurementSpec(metric_name="Situation_B", metric_group="skeletal", method_id="CRANIOM_SITUATION_B_MM_V1", construction_definition_id="CRANIOM_B_TO_N_VERTICAL_V1", unit="mm", requires_calibration=True),
    _MeasurementSpec(metric_name="Decalage_A_B", metric_group="skeletal", method_id="CRANIOM_AB_PRIME_MM_V1", construction_definition_id="CRANIOM_AB_PRIME_V1", unit="mm", requires_calibration=True),
    _MeasurementSpec(metric_name="Profondeur_Faciale", metric_group="skeletal", method_id="CRANIOM_FACIAL_DEPTH_MM_V1", construction_definition_id="CRANIOM_S_TO_N_VERTICAL_DEPTH_V1", unit="mm", requires_calibration=True),
)

_CRANIOM_ANGULAR_SPECS: Sequence[_MeasurementSpec] = (
    _MeasurementSpec(metric_name="I_Francfort", metric_group="dental", method_id="CRANIOM_U1_FRANKFORT_DEG_V1", construction_definition_id="CRANIOM_U1_TO_FRANKFORT_V1", unit="deg", requires_calibration=False, compatibility_optional=True),
    _MeasurementSpec(metric_name="IMPA", metric_group="dental", method_id="CRANIOM_L1_DOWNS_DEG_V1", construction_definition_id="CRANIOM_L1_TO_DOWNS_MP_V1", unit="deg", requires_calibration=False, compatibility_optional=True),
    _MeasurementSpec(metric_name="Inter_Incisif", metric_group="dental", method_id="CRANIOM_INTERINCISAL_DEG_V1", construction_definition_id="CRANIOM_U1_L1_INTERINCISAL_V1", unit="deg", requires_calibration=False, compatibility_optional=True),
)
...
def _required_construction(constructions: Mapping[str, ConstructionEvidence], spec: _MeasurementSpec) -> Optional[ConstructionEvidence]:
    ...
    if construction is None:
        if spec.compatibility_optional:
            return None
        raise ValueError("Missing materialized construction evidence for " f"{spec.construction_definition_id}")
    ...
    *,
    ...
    for spec in _CRANIOM_SPECS:
        ...
        adapted.append(MeasurementEvidence(
            measurement_id=f"{measurement_namespace}:{spec.metric_name}", analysis_id="CRANIOM",
            method_id=spec.method_id, method_version="1", value=value, unit=spec.unit,
            construction_refs=[construction_ref], calibration_ref=effective_calibration_ref,
            requires_calibration=spec.requires_calibration, evidence_refs=evidence_refs,
...
def adapt_craniom_linear_measurements(
    ...
    *,
    ...
    adapted = adapt_craniom_measurements(
        result, measurement_namespace=measurement_namespace,
        constructions=constructions, calibration_ref=calibration_ref,
    )
