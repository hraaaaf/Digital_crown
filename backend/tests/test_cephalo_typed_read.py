...
def test_unavailable_typed_measurement_never_falls_back_to_legacy_value():
    # Geometry can contain a legacy millimetric number from an automatic ratio, while
    # typed evidence intentionally remains uncalibrated because no audited source exists.
