...
def test_p2_additive_startup_preserves_existing_patient_archive_and_file(tmp_path):
    """Rehearse P2-style additive startup over an already populated local vault."""
    ...
    # the new additive practitioner-assignment table.
    ...
    # DB bytes must change because a new table is created; the historic rows and
    # media above are the preservation contract.
