...
class CabinetConfigBase(BaseModel):
    ...
    header_lines_fr: List[str] = Field(default_factory=list, max_length=7)
    header_lines_ar: List[str] = Field(default_factory=list, max_length=7)
    ...
    header_logo_offset_x: float = Field(default=0.0, ge=-3.0, le=3.0)
    header_logo_offset_y: float = Field(default=0.0, ge=-3.0, le=3.0)
    header_line_height: float = Field(default=1.0, ge=0.5, le=2.0)
    footer_font_scale: float = Field(default=1.0, ge=0.5, le=2.0)
    footer_qr_scale: float = Field(default=1.0, ge=0.5, le=2.0)
    footer_line_height: float = Field(default=1.0, ge=0.5, le=2.0)
    ...
    qr_code_style: str = Field(default="dots", max_length=20)
    qr_code_offset_x: float = Field(default=0.0, ge=-3.0, le=3.0)
    qr_code_offset_y: float = Field(default=0.0, ge=-3.0, le=3.0)
