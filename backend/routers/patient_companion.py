...
from backend.routers import patient_companion_activation, patient_companion_agenda, patient_companion_consents, patient_companion_finance, patient_companion_notifications, patient_companion_pairing, patient_companion_questionnaires, patient_companion_shares
