...
from backend.routers import patient_companion_activation, patient_companion_pairing, patient_companion_remote, patient_companion_shares
...
router.include_router(patient_companion_remote.router)
