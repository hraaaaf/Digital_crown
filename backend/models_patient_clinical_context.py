...
class PatientClinicalContext(Base):
    """Practitioner-entered factual context used by Prescription Intelligence.

    This table deliberately stores facts only. It does not encode dose rules,
    contraindication thresholds, diagnostic stages, or clinical readiness.
    """
    ...
    prescription_indication = Column(Text, nullable=True)
