...
**Branche closeout docs :** `docs/cephalo-r17-closeout`
...
Le dernier état exact-head est CI #3931 SUCCESS.
...
Le closeout documentaire est effectué séparément sur `docs/cephalo-r17-closeout` afin d'enregistrer le vrai merge et le prompt de reprise suivant. R17 n'est totalement clos qu'après merge de ce closeout documentaire et vérification post-merge.
...
2. Vérifier avant toute modification :
   ...
   - closeout documentaire R17 mergé sur master ;
...
1. Merger le closeout documentaire R17 après CI verte.
2. Vérifier `master` post-merge documentaire.
