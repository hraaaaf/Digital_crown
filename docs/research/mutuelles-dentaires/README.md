...
4. Les PDF/formulaires CNSS et FAR restent NON CANONIQUES tant qu’une version officielle actuelle n’est pas verrouillée depuis une source primaire.
5. Les données Honoraires et Ordonnance devront être lues depuis les sous-systèmes existants, jamais recopiées dans un second moteur.
