...
const OUTPUT_DIR = path.join(FRONTEND_DIR, 'marketplace-p5-after-artifacts');
...
const suppliers = [
  { id: 11, supplierKey: 'atlas-dental', name: 'Atlas Dental Supply', badge: 'Partenaire premium', description: 'Consommables et restauration pour cabinet dentaire.', promise: 'Livraison suivie et catalogue clinique structuré.', apiBaseUrl: null, syncMode: 'manual', isActive: true, productCount: 5 },
  { id: 12, supplierKey: 'medident-pro', name: 'Medident Pro', badge: 'Spécialiste endodontie', description: 'Instrumentation et endodontie.', promise: 'Références techniques sélectionnées pour les soins courants.', apiBaseUrl: null, syncMode: 'manual', isActive: true, productCount: 3 },
];
  ...
  for (const viewport of viewports) {
    ...
    const metrics = await page.evaluate(() => {
      ...
      return {
        ...
        firstProductTop: productRect?.top ?? null,
