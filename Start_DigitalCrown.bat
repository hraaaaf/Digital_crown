...
start "" cmd /k "title SERVEUR BACKEND && if exist venv\Scripts\activate.bat call venv\Scripts\activate.bat && uvicorn backend.main:app --host 0.0.0.0 --reload --reload-delay 2 --port 8005"
