...
- Name: login.spec.ts >> Login flow >> bouton Creer un compte navigue vers /register
- Location: tests\login.spec.ts:68:7
...
Call log:
  - waiting for getByRole('button', { name: /Cr̩er un compte/i })
...
- generic [ref=e7]:
  ...
  - generic [ref=e13]:
    - generic [ref=e14]:
      ...
      - generic [ref=e16]:
        - img [ref=e17]
        - textbox "nom@cabinet.com" [ref=e20]
    - generic [ref=e21]:
